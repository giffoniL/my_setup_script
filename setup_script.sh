...
install_apps() {
  ...
  sudo pacman -S --needed firefox micro niri wayland xorg xwayland-satellite code foot nicotine+ fuzzel vesktop-bin jdk-openjdk waydroid otf-monaspace swaybg steam timidity++ mpd ncmpcpp mako brightnessctl python python-pipx flatpak tree celluloid loupe fragments errands
